...
public class P02_Apple_FindElements {
    public static void main(String[] args) {
        ...
        driver.get("https://www.apple.com");//2. Go to https://www.apple.com
        //locating the iphone link with xpath
        WebElement iphoneLink = driver.findElement(By.xpath("//span[.='iPhone']/.."));//3. Click to iPhone
        ...
        System.out.println("Number of links without texts ===> " + linksWithoutText);//5. Print out how many link is missing text
        System.out.println("Number of links with texts ===>" + linksWithText); //6. Print out how many link has text
        System.out.println("Number of TOTAL LINKS ===> " + allLinks.size()); //7. Print out how many total link
