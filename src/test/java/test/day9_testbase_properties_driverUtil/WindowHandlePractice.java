...
/*EXTENDS TEST BASE GELINCE BURASI IPTAL OLDU
    WebDriver driver;
    @BeforeMethod //Burasi bir cok kez yaziliyor EZBERLE
    ...
    public void multiple_window_test(){
        ...
        for (String each : windowHandles) {
            ...
            if (driver.getCurrentUrl().contains("etsy")){    // 6. Assert: Title contains “Etsy”
