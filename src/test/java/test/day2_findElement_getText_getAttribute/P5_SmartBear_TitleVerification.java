...
public class P5_SmartBear_TitleVerification {
    public static void main(String[] args) {
        ...
        //2- Go to:  //Link adini cagir
        //http://secure.smartbearsoftware.com/samples/testcomplete12/WebOrders/login.aspx
        driver.get("http://secure.smartbearsoftware.com/samples/testcomplete12/WebOrders/login.aspx");
        //3- Verify title equals:
        //Expected: Web Orders Login // Boolean ile tahmin edilen durumun dogrulanmasi. if else ile.
         String actualTitle = driver.getTitle(); //beklenen durum yazi oldugu icin string olusturulmali.
